...
startup
{
    ...
    //Fully Customizabale Door Splits
...
{    
    ...
    {
        Tuple.Create(  0, 13,  1), Tuple.Create(  1,  1,  0), Tuple.Create(  2,  0,  1), Tuple.Create(  3,  1,  2), Tuple.Create(  4,  2,  3),
        Tuple.Create(  5,  3,  4), Tuple.Create(  6,  4,  3), Tuple.Create(  7,  3,  4), Tuple.Create(  8,  4,  6), Tuple.Create(  9,  6,  5),
        Tuple.Create( 10,  5,  7), Tuple.Create( 11,  7,  5), Tuple.Create( 12,  5,  8), Tuple.Create( 13,  8,  9), Tuple.Create( 14,  9, 12),
        Tuple.Create( 15, 12,  9), Tuple.Create( 16,  9, 10), Tuple.Create( 17, 10, 16), Tuple.Create( 18, 16, 17), Tuple.Create( 19, 17, 18),
        Tuple.Create( 20, 18, 19), Tuple.Create( 21, 19, 20), Tuple.Create( 22, 20, 24), Tuple.Create( 23, 24, 25), Tuple.Create( 24, 25, 26),
        Tuple.Create( 25, 26, 25), Tuple.Create( 26, 25, 24), Tuple.Create( 27, 24, 20), Tuple.Create( 28, 20, 19), Tuple.Create( 29, 19, 18),
        Tuple.Create( 30, 18, 17), Tuple.Create( 31, 17, 37), Tuple.Create( 32, 37, 36), Tuple.Create( 33, 36, 26), Tuple.Create( 34, 26, 24),
        Tuple.Create( 35, 24,  0), Tuple.Create( 36,  0,  1), Tuple.Create( 37,  1, 27), Tuple.Create( 38, 27,  2), Tuple.Create( 39,  2,  3),
        Tuple.Create( 40,  3,  5), Tuple.Create( 41,  5,  6), Tuple.Create( 42,  6, 17), Tuple.Create( 43, 17,  6), Tuple.Create( 44, 17, 18),
        Tuple.Create( 45, 18,  6), Tuple.Create( 46,  6, 22), Tuple.Create( 47, 22,  6), Tuple.Create( 48,  6,  7), Tuple.Create( 49,  7, 16),
        Tuple.Create( 50, 16, 15), Tuple.Create( 51, 15, 16), Tuple.Create( 52, 16,  7), Tuple.Create( 53,  7,  8), Tuple.Create( 54,  8,  9),
        Tuple.Create( 55,  9, 10), Tuple.Create( 56, 10, 11), Tuple.Create( 57, 11, 12), Tuple.Create( 58, 12, 12), Tuple.Create( 59, 12, 11),
        Tuple.Create( 60, 11, 10), Tuple.Create( 61, 10,  9), Tuple.Create( 62,  9,  8), Tuple.Create( 63,  8, 14), Tuple.Create( 64, 14, 13),
        Tuple.Create( 65, 13, 23), Tuple.Create( 66, 23,  8), Tuple.Create( 67,  8,  7), Tuple.Create( 68,  7,  6), Tuple.Create( 69,  6,  5),
        Tuple.Create( 70,  5,  6), Tuple.Create( 71,  6,  7), Tuple.Create( 72,  7,  8), Tuple.Create( 73,  8,  7), Tuple.Create( 74,  7,  6),
        Tuple.Create( 75,  6,  5), Tuple.Create( 76,  5,  3), Tuple.Create( 77,  3,  4), Tuple.Create( 78,  4, 19), Tuple.Create( 79, 19, 20),
        Tuple.Create( 80, 20,  4), Tuple.Create( 81,  4,  3), Tuple.Create( 82,  3,  2), Tuple.Create( 83,  2, 27), Tuple.Create( 84, 27,  1),
        Tuple.Create( 85,  1,  0), Tuple.Create( 86,  0, 24), Tuple.Create( 87, 24, 26), Tuple.Create( 88, 26, 36), Tuple.Create( 89, 36, 35),
        Tuple.Create( 90, 35, 14), Tuple.Create( 91, 14, 11), Tuple.Create( 92, 11, 27), Tuple.Create( 93, 27, 28), Tuple.Create( 94, 28, 27),
        Tuple.Create( 95, 27, 11), Tuple.Create( 96, 11, 14), Tuple.Create( 97, 14, 35), Tuple.Create( 98, 35, 36), Tuple.Create( 99, 36, 26),
        Tuple.Create(100, 26, 24), Tuple.Create(101, 24,  0), Tuple.Create(102,  0,  1), Tuple.Create(103,  1, 27), Tuple.Create(104, 27,  2),
        Tuple.Create(105,  2,  3), Tuple.Create(106,  3,  5), Tuple.Create(107,  5,  6), Tuple.Create(108,  6, 22), Tuple.Create(109, 22,  6),
        Tuple.Create(110,  6,  7), Tuple.Create(111,  7,  8), Tuple.Create(112,  8, 14), Tuple.Create(113, 14, 13), Tuple.Create(114, 13, 23),
        Tuple.Create(115, 23,  8), Tuple.Create(116,  8,  9), Tuple.Create(117,  9, 10), Tuple.Create(118, 10, 11), Tuple.Create(119, 11, 12),
        Tuple.Create(120, 12, 12), Tuple.Create(121, 12, 21), Tuple.Create(122, 21, 21), Tuple.Create(123, 21,  5), Tuple.Create(124,  5,  6),
        Tuple.Create(125,  6,  7), Tuple.Create(126,  7,  4), Tuple.Create(127,  4,  2), Tuple.Create(128,  2,  1), Tuple.Create(129,  1,  0),
        Tuple.Create(130,  0,  1), Tuple.Create(131,  1,  2), Tuple.Create(132,  2,  4), Tuple.Create(133,  4, 10), Tuple.Create(134, 10, 11),
        Tuple.Create(135, 11, 12), Tuple.Create(136, 12, 11), Tuple.Create(137, 11, 10), Tuple.Create(138, 10,  4), Tuple.Create(139,  4,  7),
        Tuple.Create(140,  7,  8), Tuple.Create(141,  8,  9), Tuple.Create(142,  9,  8), Tuple.Create(143,  8,  7), Tuple.Create(144,  7,  4),
        Tuple.Create(145,  4, 10), Tuple.Create(146, 10, 11), Tuple.Create(147, 11, 12), Tuple.Create(148, 12, 11), Tuple.Create(149, 11, 13),
        Tuple.Create(150, 13, 16), Tuple.Create(151, 16, 23), Tuple.Create(152, 23, 23), Tuple.Create(153, 23, 22), Tuple.Create(154, 22, 19),
        Tuple.Create(155, 19, 20), Tuple.Create(156, 20, 21), Tuple.Create(157, 21, 23), Tuple.Create(158, 23,  2), Tuple.Create(159,  2,  3),
        Tuple.Create(160,  3,  4), Tuple.Create(161,  4,  5), Tuple.Create(162,  4,  9), Tuple.Create(163,  9, 10), Tuple.Create(164, 10, 11),
        Tuple.Create(165, 11, 10), Tuple.Create(166, 10,  9), Tuple.Create(167,  9,  5), Tuple.Create(168,  5,  8), Tuple.Create(169,  8,  5),
        Tuple.Create(170,  5,  6), Tuple.Create(171,  6,  5), Tuple.Create(172,  5,  4), Tuple.Create(173,  5,  9), Tuple.Create(174,  9, 10),
        Tuple.Create(175, 10, 11), Tuple.Create(176, 11, 10), Tuple.Create(177, 10,  9), Tuple.Create(178,  9,  4), Tuple.Create(179,  4,  3),
        Tuple.Create(180,  3,  2), Tuple.Create(181,  2, 23), Tuple.Create(182, 23, 21), Tuple.Create(183, 21, 20), Tuple.Create(184, 20, 19),
        Tuple.Create(185, 19, 22), Tuple.Create(186, 22, 23), Tuple.Create(187, 23, 23), Tuple.Create(188, 23, 16), Tuple.Create(189, 16,  0),
        Tuple.Create(190,  0, 15), Tuple.Create(191, 15, 14), Tuple.Create(192, 14,  7), Tuple.Create(193,  7,  8), Tuple.Create(194,  8,  9),
        Tuple.Create(195,  9,  0), Tuple.Create(196,  0,  1), Tuple.Create(197,  1,  0), Tuple.Create(198,  0, 12), Tuple.Create(199, 12, 14),
        Tuple.Create(200, 14, 15), Tuple.Create(201, 15, 14), Tuple.Create(202, 14, 12), Tuple.Create(203, 12, 13), Tuple.Create(204, 13, 16),
        Tuple.Create(205, 16, 17), Tuple.Create(206, 17, 18), Tuple.Create(207, 18, 20), Tuple.Create(208, 20, 18), Tuple.Create(209, 18, 21),
        Tuple.Create(210, 21, 16), Tuple.Create(211, 16, 13), Tuple.Create(212, 13, 12), Tuple.Create(213, 12, 14), Tuple.Create(214, 14, 15),
        Tuple.Create(215, 15, 16), Tuple.Create(216, 16,  0), Tuple.Create(217,  0,  1), Tuple.Create(218,  1,  2), Tuple.Create(219,  2,  1),
        Tuple.Create(220,  1,  0), Tuple.Create(221,  0,  3), Tuple.Create(222,  3,  0), Tuple.Create(223,  0,  3), Tuple.Create(224,  3,  3),
        Tuple.Create(225,  3,  7), Tuple.Create(226,  7,  4), Tuple.Create(227,  4,  5), Tuple.Create(228,  5,  6), Tuple.Create(229,  6,  5),
        Tuple.Create(230,  5,  4), Tuple.Create(231,  4,  7), Tuple.Create(232,  7,  3), Tuple.Create(233,  3,  3), Tuple.Create(234,  3,  8),
        Tuple.Create(235,  8,  9), Tuple.Create(236,  9,  8), Tuple.Create(237,  8,  3), Tuple.Create(238,  3,  0), Tuple.Create(239,  0, 10),
